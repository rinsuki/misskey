...
module.exports = (params, user) => new Promise(async (res, rej) => {
    ...
    // Get 'name' parameter
    const [name, nameErr] = cafy_1.default(params.name).optional.string().pipe(drive_folder_1.isValidFolderName).$;
    if (nameErr)
    ...
    event_1.publishDriveStream(user._id, 'folder_updated', folderObj);
});
